...
public class Melee extends BaseHero {
    public Melee(ArrayList<BaseHero> teamList, String name, String role, String icon, int attack, int defence, int[] damage, int health, int speed, int x, int y) {
    ...
    public void step(ArrayList<BaseHero> heroList) {
        ...
        float attackPower = new Random().nextInt(damage[1] + 1 - damage[0]);
